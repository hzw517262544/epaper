...
FCKConfig.ToolbarSets["Default"] = [
	['Source','DocProps','-','Undo','Redo','-','NewPage','Preview','-','Templates'],
	['Cut','Copy','Paste','PasteText','PasteWord','-','Print','SpellCheck'],
	['Find','Replace','-','SelectAll','RemoveFormat'],
	['FitWindow','ShowBlocks'],
	'/',
	['Images','Flash','Bold','Italic','Underline','StrikeThrough','-','Subscript','Superscript'],
...
FCKConfig.ToolbarSets["Basic"] = [
	['Image','Italic','-','OrderedList','UnorderedList','-','Link','Unlink']
] ;

FCKConfig.ToolbarSets["PaperMap"] = [
	['Image','imgmapPopup','Source']
] ;

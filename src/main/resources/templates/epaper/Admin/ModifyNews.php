...
<table width="100%" border="0" cellpadding="0" cellspacing="0">
  <tr>
    ...
    <td height="29" valign="top" background="Images/content-bg.gif"><div class="titlebt">修改新闻</div></td>
...
?>
   <option value="<?=$oRs->PublishDate?>" <? if($oRs->PublishDate==$nRs[PublishDate]) {echo "selected";}?>>总第<?=$oRs->PublishID?>期</option>
<?php
...
?>
              ...
              <tr>
                <td height="30" rowspan="2" align="right">新闻内容：</td>
                <td height="15">
<?php
...
?>
              ...
              <tr>
                ...
                <input type="submit" name="ModifyNews" value="提交">

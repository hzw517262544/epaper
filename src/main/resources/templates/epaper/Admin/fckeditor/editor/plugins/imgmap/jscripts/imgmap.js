...
this.mapid="";
this.DM_rect_DRAW=1;
this.DM_rect_MOVE=11;
this.DM_rect_RESIZE_TOP=12;
this.DM_rect_RESIZE_RIGHT=13;
this.DM_rect_RESIZE_BOTTOM=14;
this.DM_rect_RESIZE_LEFT=15;
...
this.DM_poly_DRAW=3;
this.DM_poly_LASTDRAW=30;
this.DM_poly_MOVE=31;
...
_2d+="<area shape=\""+this.areas[i].shape+"\""+" alt=\""+this.areas[i].aalt+"\""+" tooltip=\""+this.areas[i].atitle+"\""+" coords=\""+this.areas[i].lastInput+"\""+" href=\""+this.areas[i].ahref+"\""+" target=\""+this.areas[i].atarget+"\" />";
}
}
}
return (_2d);
...
var _3d=_37[i].getAttribute("tooltip");
if(!_3d){
_3d=alt;
}
if(_3d){
...
if(this.is_drawing==this.DM_poly_DRAW||this.is_drawing==this.DM_poly_LASTDRAW){
...
this._polygrow(this.areas[id],_68[i],_68[i+1]);
}
this._polyshrink(this.areas[id]);
}
}
}
}
...
imgmap.prototype._polygrow=function(_6b,_6c,_6d){
...
imgmap.prototype._polyshrink=function(_72){
...
this._polygrow(_72,_72.xpoints[i],_72.ypoints[i]);
}
...
if(this.isSafari){
if(e.shiftKey){
if(this.is_drawing==this.DM_rect_DRAW){
...
this.is_drawing=this.DM_rect_DRAW;
this.statusMessage(this.strings["rect_DRAW"]);
}
}
}
if(this.is_drawing==this.DM_rect_DRAW){
...
if(this.is_drawing==this.DM_poly_DRAW){
this.fireEvent("onDrawArea",this.currentid);
this._polygrow(this.areas[this.currentid],x,y);
}else{
if(this.is_drawing==this.DM_rect_MOVE||this.is_drawing==this.DM_SQUARE_MOVE){
...
if(this.is_drawing==this.DM_poly_MOVE){
this.fireEvent("onMoveArea",this.currentid);
var x=x-this.memory[this.currentid].rdownx;
var y=y-this.memory[this.currentid].rdowny;
if(x+_7b>this.pic.width||y+_7a>this.pic.height){
...
if(this.is_drawing==this.DM_rect_RESIZE_LEFT){
this.fireEvent("onResizeArea",this.currentid);
var _7c=x-_79;
if(_7b+(-1*_7c)>0){
this.areas[this.currentid].style.left=x+1+"px";
...
this.memory[this.currentid].width=0;
this.memory[this.currentid].left=x;
this.is_drawing=this.DM_rect_RESIZE_RIGHT;
}
}else{
if(this.is_drawing==this.DM_rect_RESIZE_RIGHT){
this.fireEvent("onResizeArea",this.currentid);
var _7c=x-_79-_7b;
if((_7b+(_7c))-1>0){
...
this.memory[this.currentid].width=0;
this.memory[this.currentid].left=x;
this.is_drawing=this.DM_rect_RESIZE_LEFT;
}
}else{
if(this.is_drawing==this.DM_rect_RESIZE_TOP){
this.fireEvent("onResizeArea",this.currentid);
var _7d=y-top;
if((_7a+(-1*_7d))>0){
this.areas[this.currentid].style.top=y+1+"px";
...
this.memory[this.currentid].height=0;
this.memory[this.currentid].top=y;
this.is_drawing=this.DM_rect_RESIZE_BOTTOM;
}
}else{
if(this.is_drawing==this.DM_rect_RESIZE_BOTTOM){
this.fireEvent("onResizeArea",this.currentid);
var _7d=y-top-_7a;
if((_7a+(_7d))-1>0){
...
this.memory[this.currentid].height=0;
this.memory[this.currentid].top=y;
this.is_drawing=this.DM_rect_RESIZE_TOP;
}
}
}
}
...
x=x+this.pic_container.scrollLeft;
y=y+this.pic_container.scrollTop;
if(this.is_drawing!=this.DM_rect_DRAW&&this.is_drawing!=this.DM_SQUARE_DRAW&&this.is_drawing!=this.DM_poly_DRAW&&this.is_drawing!=this.DM_poly_LASTDRAW){
this.draggedId=null;
this.is_drawing=0;
...
if(e.shiftKey){
if(this.is_drawing==this.DM_poly_DRAW){
this.is_drawing=this.DM_poly_LASTDRAW;
}
}
if(this.is_drawing==this.DM_poly_DRAW){
...
if(this.is_drawing&&this.is_drawing!=this.DM_poly_DRAW){
if(this.is_drawing==this.DM_poly_LASTDRAW){
this.areas[this.currentid].xpoints[this.areas[this.currentid].xpoints.length]=x-5;
this.areas[this.currentid].ypoints[this.areas[this.currentid].ypoints.length]=y-5;
this._updatecoords();
this.is_drawing=0;
this._polyshrink(this.areas[this.currentid]);
}
this.is_drawing=0;
this.statusMessage(this.strings["READY"]);
this.relaxArea(this.currentid);
...
if(this.areas[this.currentid].shape=="poly"){
this.is_drawing=this.DM_poly_DRAW;
this.statusMessage(this.strings["poly_DRAW"]);
...
if(this.areas[this.currentid].shape=="rect"){
this.is_drawing=this.DM_rect_RESIZE_LEFT;
this.statusMessage(this.strings["rect_RESIZE_LEFT"]);
this.areas[this.currentid].style.borderColor=this.config.CL_DRAW_SHAPE;
}
}
}else{
...
if(this.areas[this.currentid].shape=="rect"){
this.is_drawing=this.DM_rect_RESIZE_RIGHT;
this.statusMessage(this.strings["rect_RESIZE_RIGHT"]);
this.areas[this.currentid].style.borderColor=this.config.CL_DRAW_SHAPE;
}
}
}else{
...
if(this.areas[this.currentid].shape=="rect"){
this.is_drawing=this.DM_rect_RESIZE_TOP;
this.statusMessage(this.strings["rect_RESIZE_TOP"]);
this.areas[this.currentid].style.borderColor=this.config.CL_DRAW_SHAPE;
}
}
}else{
...
if(this.areas[this.currentid].shape=="rect"){
this.is_drawing=this.DM_rect_RESIZE_BOTTOM;
this.statusMessage(this.strings["rect_RESIZE_BOTTOM"]);
this.areas[this.currentid].style.borderColor=this.config.CL_DRAW_SHAPE;
}
}
}else{
...
if(this.areas[this.currentid].shape=="rect"){
this.is_drawing=this.DM_rect_MOVE;
this.statusMessage(this.strings["rect_MOVE"]);
this.areas[this.currentid].style.borderColor=this.config.CL_DRAW_SHAPE;
this.memory[this.currentid].rdownx=_9e;
this.memory[this.currentid].rdowny=_9f;
}else{
...
this.is_drawing=this.DM_poly_MOVE;
this.statusMessage(this.strings["poly_MOVE"]);
if(this.config.bounding_box==true){
this.areas[this.currentid].style.borderColor=this.config.CL_DRAW_BOX;
}
this.memory[this.currentid].rdownx=_9e;
